...
<help@iq.harvard.edu> and someone will assist you.
...
**Login nodes**
1.   Provides access to a desktop environment (similar to Remote Desktop)
...
**Interactive nodes**
2.   Interactive nodes allow you to run applications on very powerful
...
**Batch nodes**
3.   Where interactive nodes give you access to a single very powerful
